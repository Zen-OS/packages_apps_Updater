...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.zen.base.version";
    public static final String PROP_DEVICE = "ro.zen.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.zen.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "zen.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "zen.updater.uri";
